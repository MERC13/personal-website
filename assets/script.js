...
(function () {
  ...
  function projectCard(p) {
    ...
    const repoBtn = (p.repo_url && p.repo_url !== "#" && p.repo_url !== "") ? `<a class="btn" href="${p.repo_url}" target="_blank" rel="noopener">Code ↗</a>` : "";
    const demoBtn = (p.demo_url && p.demo_url !== "#" && p.demo_url !== "") ? `<a class="btn" href="${p.demo_url}" target="_blank" rel="noopener">Demo ↗</a>` : "";
    const actions = `${repoBtn} ${demoBtn}`;
    return `
